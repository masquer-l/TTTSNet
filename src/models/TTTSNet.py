...
class MAD(nn.Module):
    def __init__(self, c1=32, c2=64, classes=19, num_features: int = 32):
        ...
        self.deep_layer_1x1 = Conv(8 * self.num_features + 3, c2, 1, 1, padding=0, bn_acti=False)
        ...
        self.DwConv2 = Conv(8 * self.num_features + 3, 8 * self.num_features + 3, (3, 3), 1, padding=(1, 1),
                            groups=8 * self.num_features + 3, bn_acti=True)
        self.PwConv2 = Conv(8 * self.num_features + 3, classes, 1, 1, padding=0, bn_acti=False)
